...
function add_chatbox_text(packet)
{
    ...
    if (is_longturn()) {
      if (text.indexOf("to the Freeciv version") != -1 || text.indexOf("waiting on") != -1 || text.indexOf("Lost connection") != -1 || text.indexOf("Not enough") != -1 || text.indexOf("has been removed") != -1 || text.indexOf("has connected") != -1) return;
    }
